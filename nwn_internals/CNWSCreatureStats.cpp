...
unsigned char 	(__thiscall *CNWSCreatureStats__GetClass)(CNWSCreatureStats *pTHIS, unsigned char) = (unsigned char(__thiscall*)(CNWSCreatureStats *pTHIS, unsigned char))0x00473270;
...
unsigned char CNWSCreatureStats_s::GetClass(unsigned char ClassType) {
	return CNWSCreatureStats__GetClass(this, ClassType);
}
