...
signed int			(__thiscall *CNWSCreature__AddAttackActions)(CNWSCreature*, nwn_objid_t target, int a3, int a4, int a5) = (signed int (__thiscall *)(CNWSCreature*, nwn_objid_t target, int a3, int a4, int a5))0x00493810;
int					(__thiscall *CNWSCreature__GetIsPossessedFamiliar)(CNWSCreature*) = (int (__thiscall *)(CNWSCreature * pThis))0x004CE920;
void				(__thiscall *CNWSCreature__BroadcastAttackofOpportunity)(CNWSCreature*, nwn_objid_t oID, int a3) = (void (__thiscall *)(CNWSCreature * pThis, nwn_objid_t oID, int a3))0x004A27C0;
void				(__thiscall *CNWSCreature__ApplyOnHitVampiricRegeneration) (CNWSCreature *cre, CNWSObject *obj, CNWSItemProperty *prop) = (void (__thiscall *) (CNWSCreature *cre, CNWSObject *obj, CNWSItemProperty *prop)) 0x005558A0;
//void Destructor(char c) {
	//CNWSCreature__dtor_CNWSCreature(this, c);
//}
void CNWSCreature::ApplyOnHitVampiricRegeneration(CNWSObject *obj, CNWSItemProperty *prop){
	CNWSCreature__ApplyOnHitVampiricRegeneration(this, obj, prop);
}

int CNWSCreature_s::GetIsPossesedFamiliar(){
	return CNWSCreature__GetIsPossessedFamiliar(this);
}

signed int CNWSCreature_s::AddAttackActions(nwn_objid_t target, int a3, int a4, int a5){
	return CNWSCreature__AddAttackActions(this, target,  a3,  a4,  a5);
}
...
void CNWSCreature_s::BroadcastAttackofOpportunity(nwn_objid_t target, int tumble){
	CNWSCreature__BroadcastAttackofOpportunity(this, target, tumble);
}