...
//	void				*v_table;						/* 0x0000 */
  ...
  int ru_feats_len;                   //D6                  
  unsigned __int8 ru_classes_length;  //DA                  
  unsigned __int8 ru_unknown1_length; //DB                  
  unsigned __int8 ru_unknown2_length; //DC                  
  unsigned __int8 ru_skills_length;   //DE                  
  int ru_spells_len;                  //DF                  
  CNWClass *ru_classes;               //E0                  
  int ru_races_len;                                     
  int ru_skills_len;                                    
  int ru_domains_len;                                   
